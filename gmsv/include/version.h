...
#define FAMILY_MAXHOME 10        // (4.0) 家族据点
#define MANORNUM       10        // (4.0) 庄园数量
#define FMPOINTNUM     10        // (4.0) 有据点家族的最大数量
#endif
...
#define	_FM_NPC_LOOK_WAR		//家族布告栏可以看到族战列表,观看族战NPC
...
#endif
#define SERVER_VERSION "紫云版 GMSV_8.0服务端v3.0.1.2 for linux"
#else
//#define _SA75
#ifdef _SA75
...
#define SERVER_VERSION "紫云版GMSV_7.5服务端v2.3.7.6 for linux"
#endif
