...
void saacproto_ACCharDelete_recv( int fd,char* id,char* passwd,char* charname,char* option,int mesgid, char* userip ) ; /* ../../doc/saacproto.html line 231 */
...
void saacproto_ACNewDelFM_recv(int fd, int index, int charfdid);
void saacproto_ACSystemAllTalk_send( int fd, char *data );
void saacproto_ACSystemAllTalk_recv( int fd, char *data);
void saacproto_ACPlayerAllTalk_send( int fd,char *servername,char *playname, char *data );
void saacproto_ACPlayerAllTalk_recv( int fd, char *servername,char *playname,char *data);
#endif                	
